...
set BIN=bin\Debug
set CODE_EDITOR_LIBS=%BIN%\Boo*.dll %BIN%\CodeEditor.Collections.dll %BIN%\CodeEditor.Composition.dll %BIN%\CodeEditor.Grammars*.dll %BIN%\CodeEditor.IO.dll %BIN%\CodeEditor.Languages*.dll %BIN%\CodeEditor.Text.*.dll %BIN%\CodeEditor.Remoting.dll
